...
public interface ApicasesReportMapper extends MyMapper<ApicasesReport> {
    ...
    List<ApicasesReport> findApicasereportWithNameandStatus(@Param("testplanid") long planid, @Param("status") String status, @Param("batchname") String batchname,@Param("projectid")long projectid, @Param("scenename") String scenename, @Param("casename") String casename, @Param("servicetype") String servicetype);
