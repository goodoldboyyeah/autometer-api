...
public interface ApicasesReportPerformanceMapper extends MyMapper<ApicasesReportPerformance> {
    ...
    List<ApicasesReportPerformance> finddynamicresultbystatus(@Param("testplanid") long planid, @Param("batchname") String batchname, @Param("tableName") String tableName, @Param("status") String status, @Param("servicetype")String servicetype);
