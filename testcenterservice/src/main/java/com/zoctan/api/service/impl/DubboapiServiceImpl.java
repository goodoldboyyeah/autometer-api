...
public class DubboapiServiceImpl extends AbstractService<Dubboapi> implements DubboapiService {
    ...
    @Override
    public void updateApibymodelid(long modelid, String modelname,String version,String dgroup) {
        dubboapiMapper.updateApibymodelid(modelid, modelname, version, dgroup);
    }
