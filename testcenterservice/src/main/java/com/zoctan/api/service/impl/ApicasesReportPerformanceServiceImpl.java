...
private ApicasesReportPerformanceMapper apicasesReportPerformanceMapper;
    ...
    @Override
    public List<ApicasesReportPerformance> finddynamicresultbystatus(long planid, String batchname, String tableName, String status,String servicetype) {
        return apicasesReportPerformanceMapper.finddynamicresultbystatus(planid, batchname, tableName, status,servicetype);
    }
