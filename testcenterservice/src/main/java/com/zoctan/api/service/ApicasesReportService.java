...
public interface ApicasesReportService extends Service<ApicasesReport> {
    ...
    List<ApicasesReport> findApicasereportWithNameandStatus(long planid,String status,String batchname,long projectid,String scenename,String casename,String servicetype);
    ...
    List<ApicasesReport> listallresult(long projectid);
