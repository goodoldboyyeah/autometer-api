...
public class DeployunitController {
    ...
    public Result add(@RequestBody Deployunit deployunit) {
        ...
        con.createCriteria().andCondition("projectid = "+deployunit.getProjectid())
                .andCondition("servicetype = '"+deployunit.getServicetype()+"'")
        ...
        {
            deployunit.setDeployunitname(deployunit.getDeployunitname().replaceAll("\\s+", ""));
    ...
    public Result listall(@RequestParam long projectid,@RequestParam String servicetype) {
        Condition con=new Condition(Deployunit.class);
        con.createCriteria().andCondition("projectid = "+projectid).andCondition("servicetype = '"+servicetype+"'");
