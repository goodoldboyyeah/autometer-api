...
export const asyncRouterMap = [
  ...
  },
  {
    ...
    icon: 'deploy',
    children: [
      { path: 'depunit/list', name: 'Http微服务', component: _import('deployunit/depunit/index'), meta: { title: 'Http微服务', permission: ['depunit:list'] }, icon: 'testmanager' },
      // { path: 'api/list', name: 'Http接口', component: _import('deployunit/api/index'), meta: { title: 'API接口', permission: ['api:list'] }},
      { path: 'dubbodepunit/list', name: 'Dubbo微服务', component: _import('deployunit/dubbodepunit/index'), meta: { title: 'Dubbo微服务', permission: ['depunit:list'] }, icon: 'testmanager' }
      // { path: 'dubboapi/list', name: 'Dubbo接口', component: _import('deployunit/dubboapi/index'), meta: { title: 'Dubbo接口', permission: ['dubboapi:list'] }},
      // { path: 'wsdepunit/list', name: 'WebSocket微服务', component: _import('deployunit/wsdepunit/index'), meta: { title: 'WebSocket微服务', permission: ['depunit:list'] }, icon: 'testmanager' }
      // // { path: 'dubboapi/list', name: 'WebSocket接口', component: _import('deployunit/dubboapi/index'), meta: { title: 'Dubbo接口', permission: ['dubboapi:list'] }},
      // { path: 'dubbodepunit/list', name: 'Tcp微服务', component: _import('deployunit/dubbodepunit/index'), meta: { title: '微服务', permission: ['depunit:list'] }, icon: 'testmanager' },
      // // { path: 'dubboapi/list', name: 'Tcp接口', component: _import('deployunit/dubboapi/index'), meta: { title: 'Dubbo接口', permission: ['dubboapi:list'] }},
      // { path: 'dubbodepunit/list', name: 'Thrift微服务', component: _import('deployunit/dubbodepunit/index'), meta: { title: '微服务', permission: ['depunit:list'] }, icon: 'testmanager' },
      // // { path: 'dubboapi/list', name: 'Thrift接口', component: _import('deployunit/dubboapi/index'), meta: { title: 'Dubbo接口', permission: ['dubboapi:list'] }},
      // { path: 'dubbodepunit/list', name: 'GRPC微服务', component: _import('deployunit/dubbodepunit/index'), meta: { title: '微服务', permission: ['depunit:list'] }, icon: 'testmanager' }
      // { path: 'dubboapi/list', name: 'GRPC接口', component: _import('deployunit/dubboapi/index'), meta: { title: 'Dubbo接口', permission: ['dubboapi:list'] }}
    ]
  },
  // {
  //   path: '/executecenter',
  ...
  //   icon: 'execute',
  //   children: [
  //     { path: 'apicases/list', name: 'Web用例库', component: _import('assets/cases/apicases/index'), meta: { title: 'Http接口用例库', permission: ['apicases:list'] }, icon: 'testmanager' },
  //   ]
  // },
  // {
  //   path: '/executecenter',
  ...
  //   icon: 'execute',
  //   children: [
  //     { path: 'apicases/list', name: 'App用例库', component: _import('assets/cases/apicases/index'), meta: { title: 'Http接口用例库', permission: ['apicases:list'] }, icon: 'testmanager' },
  //   ]
  // },
  {
    path: '/deployunitapi',
    ...
    icon: 'api',
    children: [
      { path: 'api/list', name: 'Http-API', component: _import('deployunit/api/index'), meta: { title: 'API接口', permission: ['api:list'] }},
      { path: 'dubboapi/list', name: 'Dubbo-API', component: _import('deployunit/dubboapi/index'), meta: { title: 'Dubbo接口', permission: ['dubboapi:list'] }}
      // { path: 'wsapi/list', name: 'WebSocket-API', component: _import('deployunit/wsapi/index'), meta: { title: 'WebSocket接口', permission: ['wsapi:list'] }}
      // { path: 'dubboapi/list', name: 'Tcp接口', component: _import('deployunit/dubboapi/index'), meta: { title: 'Dubbo接口', permission: ['dubboapi:list'] }},
      // { path: 'dubboapi/list', name: 'Thrift接口', component: _import('deployunit/dubboapi/index'), meta: { title: 'Dubbo接口', permission: ['dubboapi:list'] }},
      // { path: 'dubboapi/list', name: 'GRPC接口', component: _import('deployunit/dubboapi/index'), meta: { title: 'Dubbo接口', permission: ['dubboapi:list'] }}
    ]
  },
  {
    ...
    icon: 'funtest',
    children: [
      { path: 'apicases/list', name: 'Http用例库', component: _import('assets/cases/apicases/index'), meta: { title: 'Http用例库', permission: ['apicases:list'] }, icon: 'testmanager' },
      { path: 'dubboapicases/list', name: 'Dubbo用例库', component: _import('assets/cases/dubboapicases/index'), meta: { title: 'Dubbo用例库', permission: ['apicases:list'] }, icon: 'testmanager' }
      // { path: 'wsapicases/list', name: 'Websocket用例库', component: _import('assets/cases/wscases/index'), meta: { title: 'Websocket用例库', permission: ['apicases:list'] }, icon: 'testmanager' }
      // { path: 'apicases/list', name: 'Tcp接口用例库', component: _import('assets/cases/apicases/index'), meta: { title: 'Dubbo接口用例库', permission: ['apicases:list'] }, icon: 'testmanager' },
      // { path: 'apicases/list', name: 'GRPC接口用例库', component: _import('assets/cases/apicases/index'), meta: { title: 'Dubbo接口用例库', permission: ['apicases:list'] }, icon: 'testmanager' },
      // { path: 'apicases/list', name: 'Thrift接口用例库', component: _import('assets/cases/apicases/index'), meta: { title: 'Dubbo接口用例库', permission: ['apicases:list'] }, icon: 'testmanager' }
      // { path: 'apicases/list', name: 'WebUI用例库', component: _import('assets/cases/apicases/index'), meta: { title: 'WebUI用例库', permission: ['apicases:list'] }, icon: 'testmanager' },
    ]
  },
  {
    path: '/executecenter',
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'enviromentvariables/list', name: '环境变量', component: _import('testvariables/enviromentvariables/index'), meta: { title: '环境变量', permission: ['enviromentvariables:list'] }}
...

  {
    ...
    children: [
      ...
      // { path: 'appkey/list', name: '秘钥管理', component: _import('system/appkey/index'), meta: { title: '秘钥管理', permission: ['appkey:list'] }}
    ]
  },
