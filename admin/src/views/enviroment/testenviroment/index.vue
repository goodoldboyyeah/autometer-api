  ...
  <div class="app-container">
    ...
    <el-dialog title="组件配置" width="1230px" :visible.sync="AssembleDeployFormVisible">
      ...
      >
        ...
        <el-table-column label="组件名称" :show-overflow-tooltip="true" align="center" prop="deployunitname" width="70"/>
        <el-table-column label="组件类型" :show-overflow-tooltip="true"  align="center" prop="assembletype" width="90"/>
