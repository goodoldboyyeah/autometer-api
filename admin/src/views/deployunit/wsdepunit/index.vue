<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column :show-overflow-tooltip="true"  label="基础路径" align="center" prop="baseurl" width="70"/>
    ...
    ></el-pagination>
    <el-dialog :title="textMap[dialogStatus]" width="800px" @close="closedia"  :visible.sync="dialogFormVisible" :close-on-click-modal="false">
      <el-form
        status-icon
        class="small-space"
        label-position="left"
...
export default {
  ...
  created() {
    ...
    this.tmpmodel.projectid = window.localStorage.getItem('pid')
  },
