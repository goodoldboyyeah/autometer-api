...
<!--            >添加前置延时</el-button>-->
    ...
    <el-dialog title="Websocket用例操作"  width="1000px"  :visible.sync="caseoperationialogFormVisible">
      <el-form
        status-icon
        class="small-space"
        label-position="left"
                    ...
                    <el-tab-pane label="参数" name="zero">
                      <template>
                          <el-form-item  prop="apiparamvalue" >
                            <el-input
                              type="textarea"
                              style="width: 900px;height: 400px;color: #0000FF"
                              rows="20" cols="70"
                              prefix-icon="el-icon-message"
                              auto-complete="off"
                              v-model.trim="tmpapicasesbodydata.apiparamvalue"
...
<script>
  ...
  import { addapicasesdata as addapicasesdata, updateapicasesdata } from '@/api/assets/wsapicasesdata'
  import { getcasedatabycaseid, updatedubbocasedata } from '@/api/assets/wsapicasesdata'
  import { getapiListbydeploy as getapiListbydeploy, getapi } from '@/api/deployunit/wsapi'
  ...
  export default {
    ...
    methods: {
      ...
      showApi(e) {
        console.log('当前行：', e)
        if (e.servicetype === 'WebSocket服务') {
          this.$router.push({ path: '/deployunitapi/api/list', query: { apiname: e.apiname }})
        }
        if (e.servicetype === 'Dubbo服务') {
      ...
      apiconditionmodelselectChanged(e) {
        ...
        if (this.tmpapicondition.servicetype === 'WebSocket服务') {
      ...
      getapicasesList() {
        ...
        this.search.servicetype = 'WebSocket服务'
      ...
      modelselectChanged(e) {
        ...
        if (this.tmpapicases.servicetype === 'WebSocket服务') {
          getapiListbydeploy(this.apiQuery).then(response => {
            this.apiList = response.data
          }).catch(res => {
            this.$message.error('加载api列表失败')
      ...
      searchBy() {
        ...
        this.tmpservicetype = 'WebSocket服务'
      },
      ...
      async showcaseoperationDialog(index) {
        ...
        // if (this.apicasesList[index].servicetype === 'WebSocket服务') {
        //   this.caseoperationialogFormVisible = true
