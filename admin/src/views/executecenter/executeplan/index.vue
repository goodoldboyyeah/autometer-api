...
<!--          </el-form-item>-->
    ...
    <el-dialog :title="SceneapiconditiontextMap[SceneconditiondialogStatus]" width="800px"  :visible.sync="SceneconditiondialogFormVisible">
      ...
      >
        ...
        <el-form-item  label="服务类型:" prop="servicetype" >
          <el-select  v-model="tmpsceneapicondition.servicetype" filterable clearable  placeholder="服务类型"  style="width: 500px"  @change="servicetypeselectChanged($event)">
            <div v-for="(servicetype, index) in servicetypeList" :key="index">
              <el-option :label="servicetype.dicitmevalue" :value="servicetype.dicitmevalue" />
            </div>
          </el-select>
  ...
  export default {
    ...
    methods: {
      ...
      handleInput(event) {
        ...
        console.log(value)
        // 更新输入框的值
        this.tmpplanbatch.batchname = value.trim()
      ...
      showUpdatesceneconditionDialog(index) {
        ...
        this.tmpsceneapicondition.servicetype = this.sceneapiconditioncaseList[index].servicetype
      ...
      sceneconditionmodelselectChanged(e) {
        ...
        if (this.tmpsceneapicondition.servicetype === 'Dubbo服务') {
          getdubboapiListbydeploy(this.tmpsceneapicondition).then(response => {
            this.sceneconditionapiList = response.data
          }).catch(res => {
            this.$message.error('加载Dubboapi列表失败')
          })
        }
        if (this.tmpsceneapicondition.servicetype === 'Http服务') {
      ...
      ShowAddPlanSceneconditionDialog(index) {
        ...
        this.tmpsceneapicondition.servicetype = ''
