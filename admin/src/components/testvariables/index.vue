    ...
    <el-tab-pane label="接口变量" name="zero">
      <template>
        ...
        >
          ...
          <el-table-column :show-overflow-tooltip="true"   label="变量名" align="center" prop="testvariablesname" width="100"/>
          <el-table-column :show-overflow-tooltip="true"   label="变量类型" align="center" prop="valuetype" width="80"/>
          <el-table-column :show-overflow-tooltip="true"   label="来源用例" align="center" prop="casename" width="100"/>
          <el-table-column :show-overflow-tooltip="true"   label="来源微服务" align="center" prop="deployunitname" width="120"/>
          <el-table-column :show-overflow-tooltip="true"   label="来源类型" align="center" prop="testvariablestype" width="80"/>
    ...
    <el-tab-pane label="数据库变量" name="first">
      <template>
        ...
        >
          ...
          <el-table-column :show-overflow-tooltip="true"   label="变量类型" align="center" prop="valuetype" width="80"/>
          <el-table-column :show-overflow-tooltip="true"   label="表列名" align="center" prop="fieldname" width="120"/>
          <el-table-column :show-overflow-tooltip="true"   label="表行号" align="center" prop="roworder" width="60"/>
    ...
    <el-tab-pane label="脚本变量" name="second">
      <template>
        ...
        >
          ...
          <el-table-column :show-overflow-tooltip="true"   label="变量名" align="center" prop="scriptvariablesname" width="180"/>
          <el-table-column :show-overflow-tooltip="true"   label="变量类型" align="center" prop="valuetype" width="80"/>
          <el-table-column :show-overflow-tooltip="true"   label="来源" align="center" prop="conditionname" width="180"/>
    ...
    <el-tab-pane label="全局变量" name="third">
      <template>
        ...
        >
          ...
          <el-table-column :show-overflow-tooltip="true"   label="变量名" align="center" prop="keyname" width="100"/>
          <el-table-column :show-overflow-tooltip="true"   label="变量类型" align="center" prop="keyvalue" width="250"/>
    ...
    <el-tab-pane label="随机变量" name="four">
      <template>
        ...
        >
          ...
          <el-table-column :show-overflow-tooltip="true"   label="变量名" align="center" prop="variablesname" width="150"/>
          <el-table-column :show-overflow-tooltip="true"   label="变量类型" align="center" prop="variablestype" width="120"/>
          <el-table-column :show-overflow-tooltip="true"   label="变量条件" align="center" prop="variablecondition" width="140"/>
    ...
    <el-tab-pane label="环境变量" name="five">
      <template>
        ...
        >
          ...
          <el-table-column :show-overflow-tooltip="true"   label="环境名" align="center" prop="envname" width="120"/>
